...
const val TAG_FOR_CALCULATOR: String = "tagCalculatorFragment"
const val TAG_FOR_MAIN_SCREEN: String = "tagMainScreenFragment"
const val TAG_FOR_LIST_FILES: String = "tagTextListFragment"
const val TAG_FOR_DETAIL: String = "tagDetailFragment"

const val KEY_TRANSFER_NAME: String = "token"
const val KEY_INFO_DIALOG: String = "keyInfo"
